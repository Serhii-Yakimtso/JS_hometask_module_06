...
//   console.table(users), array.map(({ balance }) => balance).reduce(total, balance) => (console.log("total = ", total, ";  balance = ", balance), total + balance, console.log("final total = ", total))
// );
...
//   ),
//   array.map(({ balance }) => balance).reduce((total, value) => total + value)
// );
